...
Every dataset has a challenge/handicap.
...
%------------------------------------------------------------------------------
Although the scene contains a lot occlusion artefacts and resolution loss, especially on the left
side of the image, the results, a 100\% detection and true positive rate are very promissing.
This is due the high level of interpretation of the Histogram function.
The histogram function has a very consistent pattern, at every window area its
shape is  convex and every non-window its shape is concave.
One of the reason this holds is the nature of its kind

Using the sign change method seem to work realy well on both datasets.
\TODO{compaire to other classification method}
% but whyyyyyyyy? (ali-g)
 the classification module 
this is probably because 

%-------------------
%afkijken bij window alignment
...
point it will fail?
This could be investigated by using low quality images (which are taken for
