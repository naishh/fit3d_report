...
for, and robust to, scenes with a variation in window sizes and types. This makes the connected corner approach
	suitable for a wide range of window scenes where no or few prior
	information about the windows is known. Furthermore as no rectification
	step is needed, the system has a low input requirement that is independent of 
	calibrated input data and 3d information about the building.
...
\fig{w_Spil1TransCrop1_ImHoughResult.eps}{Result of the facade rectification}{0.45}
...
\fig{w_Spil1TransCrop1_ImHoughResult.eps}{Dataset: Anne1, Houghlines with endpoints}{0.45} 
\fig{w_Spil1TransCrop1_ImHibaap.eps}{Dataset: Anne1, (smoothed) Histograms and window alignment lines}{0.45}
...
\fig{w_Spil1TransImproved_Xv.eps}{Dataset: Anne2, Improved window alignment: Xh: total amount of overlapping horizontal Houghlines at each x position}{0.7}
\fig{w_Spil1TransImproved_Xh.eps}{Dataset: Anne2, Improved window alignment: Using the shape of the horizontal Houghlines amount as window alignment}{0.7}
\fig{w_Spil1TransImproved_Xvh.eps}{Dataset: Anne2, Improved window alignment: Both methods combined}{0.7}
\fig{w_Spil1TransImproved_WAlinesMerged.eps}{Dataset: Anne2, Improved classification method: Concave and convex shapes on window/nonwindow locations}{0.7}
\fig{w_Spil1TransImproved_windowsGrouped.eps}{Dataset: Anne2, Improved classification method: the extracted windows, red:the grouping}{0.7}
...
see section \TODO{ref section rectification}
...
\subsubsection{Discussion}  % both methods
\TODO{fuse discussions of method I and II}
