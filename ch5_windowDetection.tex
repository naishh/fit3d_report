...
Therefore we rectify the facade, which can be achieved in a manual or automatic way.\\
...
We started by taking a series of 7 consecutive images (steady zoom, lightning, etc. parameters) of a scene.  The images don't need to be chronological but need to have sufficient overlap. 
...
angle describing the magnitude of the rotation about this axis, see
\ref{sec:axisAngle}.
