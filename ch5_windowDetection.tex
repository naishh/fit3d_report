...
\fig{w_Dirk4Trans_ImHibaap_Xvh.eps}{Dataset: Anne2, Basic+Improved window alignment combined}{0.45}
\fig{w_Dirk4Trans_ImHibaap_Xvh_zoom.eps}{Dataset: Anne2, Basic+Improved window alignment combined, zoomed}{0.45}

\paragraph{Discussion}
\TODO{talk about why the combination is strong}
