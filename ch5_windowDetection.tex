...
A window often consists of several sub windows enclosed in rectangular window
...
because it interprets the derivative of the histogram function.\\
	...
	which is determined by the window with many sub windows which produce a large
