...
\fig{w_Spil1TransImproved_WAlinesMerged.eps}{Classification method II: Concave and convex shapes on window/nonwindow locations}{0.7}
\fig{w_Spil1TransImproved_windowsGrouped.eps}{Classification method II: the extracted windows, red:the grouping}{0.7}
...
\fig{w_Dirk4Trans_ImClassRect.eps}{Classification method II: Grouped windows}{0.45}
