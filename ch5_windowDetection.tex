...
% thesis outline:
This chapter is organised as follows, we start with a variety of applications that
...
orthogonal and aligned windows.  Finally we show and discuss our results. 
...
\paragraph{Building recognition and urban planning}
	...
	street level.
	Building recognition is done by using large image datasets where the
