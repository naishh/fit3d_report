...
%todo
\subsubsection{Discussion}  % (What do my results mean to me and why)
...
% \ref{fig:w_Dirk4Trans_ImHoughResult.eps}
...
\paragraph{Anne dataset}

It is easy to see in Figure \ref{fig:w_Dirk4Trans_ImHibaap_Xvh.epsi} that there are 
too many alignment lines detected. This is caused by the partially aligned scene
the two front doors % -----------------------------------


%todo onder andere

This is however not a problem because a) close alignment lines are fused and b)
subwindows are grouped to single windows, see red rectangles in Figure
\ref{fig:w_Dirk4Trans_ImClassRect.eps}.

As the sub windows are grouped to single windows 
Dirk to much alignment lines
For the actual detection of the windows (red rectangles) it is not a problem.

Its also interesting to see that 100 percent of the 0 alignment lines are positioned at window areas.
