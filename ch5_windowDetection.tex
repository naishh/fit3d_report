...
This effective way of projecting saves computational costs.
...
First we decrease the total number of found window alignment locations by increasing the individual thresholds (from 0.5*max
...
\fig{w_Dirk4Trans_ImHibaap_Xvh_zoom.eps}{Dataset: Dirk, Regular and alternative window alignment combined, close-up}{0.45}
\clearpage
...
For each blockrow the pixels of all vertical Hough lines that overlap with that
...
classification method: The red line shows concave shapes at window locations and
convex shapes at non-window locations}{0.40}
...
\paragraph{Window classification} %window classification method 1
