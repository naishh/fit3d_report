...
detection are presented, the first is based on cornerfeatures and the second on
Histogram based window alignment.  The product is a 3D annotated scene where the
