...
%\fig{p_projection_profiles.eps}{Projection profiles of See and Nevatias work}{0.5}
...
\figs{label_window_nice_geometry}{p_window_nice_geometry1.eps}{p_window_nice_geometry2.eps}{original texture}{reconstruction}{Results of Muller et all}{0.2}{0.2}
...
way as we explained in chapter %todo 
