...
To get more detailed information about the values behind the
classification a probabilistic function is developed. 
...
In Figure %todo
the values for each rectangle are displayed.

Furthermore we designed a more visual presentation, Figure %todo
------------------------------------------------------------------------------------
The whiter the area the more propable a window is classified by b



Te get 
To get insight of the probabilities that lie behind 
For detection purpose a more gradual
