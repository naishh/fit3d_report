...
We first determine the alignment of the windows and then extract the windows.
...
To handle this occlusion artefact and to increase accuracy we combining the
