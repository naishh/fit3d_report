...
On one of the matching strategies they compared the edges of a 3d model to Hough lines of the ground images.
...
These disambiguation criterea are also implicitly used in our window detector.\\
...
doesn't require laserdata.\\



Another interesting research is done by Muller et all,
%TODO REF
they use symmetry detection combined with shape grammars for the task of window detection.
%[Image-based procedural modeling of Facades]
%todo insert an image of this paper of the nice geometry (ingevallen raam)
Yet another approach is to describe the windows with Haar like features and fet them into a (Ada boost) cascaded classifier
%todo ref
