...
For debug purpose and to get more detailed idea of the probabilities behind the
...
In Figure %todo
the rectangels contain a number that is constructed summing up the normalized
value of $R_
normalised by its maximum
probability
of 
