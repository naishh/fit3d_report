...
%TODO onderstaand moet wel aan staan dus ff package downen op laptop?
...
% overlap
	...
	%TODO howcome we don't need P (rotation matrix)
	...
	see preliminaries %TODO REF over hoe je van 2 coords naar een lijn gaat
	...
	%TODO goed woord voor NADERHAND 
	after
	We calculated these values using the fit3d toolbox.%TODO Ref
	 See prelimanaries (%TODO
	) for detail.\\  
