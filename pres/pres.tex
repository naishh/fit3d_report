...
\frame
{
	...
	% out of the scope, is explained in my thesis
		...
		\end{itemize}
	\fig{FIT3DImgSequence.eps}{width=200px}
	\end{itemize}
}
...
\frame
{
	\fig{w_Dirk4Trans_ImClassRectI_kmeansLuck_barsV.eps}
}

\frame
{
	\fig{w_Dirk4Trans_ImClassRectI_kmeansLuck_barsH.eps}
}
...
% we made a valueble effort towards human-like interpretation of urban scenes
%-----------------------------------------
}
