...
%TODO ML 
% check edge detector at different dataset and compare results
...
\figs{outputskylineFloriande}{outputSkylineIm3-2.eps}{outputSkylineIm3-3.eps}{The output of the edge detector and the skyline detector.}{The output of the edge detector}{The output of the skyline detector. The skyline elements are marked red}
%TODO commands.tex fixen want de caption van b staat bij a

%TODO uitzoeken waarom kwaliteit slecht is, het gaat fout zodra matlab het image showed in een figure window en opslaat
\figs{outputskylineSpil}{outputSkylineSpil-Im13-thresh030.eps}{outputSkylineSpil-Im13-thresh070.eps}{TODO}{TODO}{TODO}
%TODO Im1 invoegen en zeggen dat het dus verkeerd gaat met een te hoge thresh
...
Other objects in the air that appear above the building but contain a sharp edge,
...
autonomity.  We didn't focus on the development of a more accurate skyline
...
done in this neighborhood. In this way the outliers, (e.g. the lamp and the
