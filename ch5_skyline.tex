...
that is allowed is to provide the system some parameters. We will now discuss
...
The preprocess of the related algorithm 
%----------------------------------------------------------------------------------------------------
...
detecting edges. 
This is a very basic method and more sophisticated edge
...
Laplacian	The Laplacian of Gaussian method finds edges by looking for zero crossings after filtering I with a Laplacian of Gaussian filter.
zero-cross	The zero-cross method finds edges by looking for zero crossings after filtering I with a filter you specify.
