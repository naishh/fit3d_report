...
Castano et al. []%TODO ref
present a good introduction of different skyline
...
building contour so this method would be an overkill.  % TODO images?
...
%TODO
et all [], %TODO Ref vision-guided flight stability and control for micro air vehicles
use a horizon detector that takes advantage of the high altitude of the vehicle, the
...
idea some inspiration for chapter %TODO Ref
...
%TODO
 et al.[] %TODO Ref 9
use skyline detection in planetary rovers to estimate their location.  Their
...
%TODO REF Planetary Rover localization [9] 
