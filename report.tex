...
% in de applicatie dia een uml schema maken van iets
...
Some results on the Floriande dataset can be seen in Figure \ref{fig:outputskyline}.
\textit{TODO quote Isaac here}
...
dit is een reftest a~\ref{labeltest}



% todo aanzetten
\figs{outputskyline}{outputSkylineIm3-2.eps}{outputSkylineIm3-3.eps}{caption1}{caption2}{1}
...
\textit{I don't remember the theory behind it and can't find it in
Isaac's paper. Would you explain this Isaac?}
...
camera center.
The main algorithm is now explained. In the next section the intersection point -
...
corner-point of the wallside is returned. This is illustrated in Figure
\ref{fig:d.eps}.
...
Take a look at Figure \ref{d.eps} again, consider the angles between the wallsegment and the
