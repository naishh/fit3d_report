...
% \fig{outputSkylineIm3-1.eps}{caption}{0.5}
% \fig{outputSkylineIm3-2.eps}{caption}{0.5}
% \fig{outputSkylineIm3-3.eps}{caption}{0.5}

% todo aanzetten
%\figs{maincaption}{outputSkylineIm3-2.eps}{outputSkylineIm3-3.eps}{caption1}{caption2}{1}
...
Then the retrieved skyline of section %TODO
...
%TODO Label
\fig{d.eps}{The behavior of the distance measure $d$. For $p$ and $q$ the euclidean distance to the closest corner point is
taken. For $q$ the perpendicular projection distance is taken}{0.2}
...
% TODO dia , endpoints w labelen met w_l w_r
