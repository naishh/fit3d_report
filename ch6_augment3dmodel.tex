...
% 	%TODO example image
	...
	%see figure%TODO.
	This overlap assumption is used as a Heuristic to search for the most
	likely wall. 

	A line segment is projected to all walls and the overlap is
...
segment is classified as the most likely wall for that line segment.
	...
	The line-wall overlap is normalised by the line segments length:\\
	$\alhpa_{l} = \fac{lwo}{|l|} 
...
%one of the vertical wallsides
	...
	point where $l$ intersects the determined vertical wallside.

------------------------------------------------------------------------------------------------------------------------------------
	Now lets consider the overlap type where no points are in the polygon.
	according to figure %todo
	this could be either a full or a zero overlap.
	Both angles above method is also applied.
