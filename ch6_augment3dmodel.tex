...
% {
% \begin{pspicture}(0,-7.2317185)(23.60875,7.6267185)
% \psframe[linewidth=0.01,dimen=outer](6.689375,7.0132813)(3.689375,2.0132813)
% \usefont{T1}{ppl}{m}{n}
% \rput(3.5725,7.423281){a}
% \usefont{T1}{ppl}{m}{n}
% \rput(6.577344,7.423281){b}
% \psline[linewidth=0.02cm,linestyle=dashed,dash=0.16cm 0.16cm,arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.4]{->}(6.689375,2.0132813)(3.189375,6.6132812)
% \psline[linewidth=0.02cm,linestyle=dashed,dash=0.16cm 0.16cm,arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.4]{->}(3.689375,2.0132813)(0.189375,6.6132812)
% \psline[linewidth=0.04cm](0.189375,6.6132812)(3.189375,6.6132812)
% \usefont{T1}{ppl}{m}{n}
% \rput(3.2773438,1.9232812){d}
% \usefont{T1}{ppl}{m}{n}
% \rput(6.9671874,1.9232812){c}
% \psarc[linewidth=0.01](3.689375,2.0132813){0.6}{0.0}{126.869896}
% \psarc[linewidth=0.01](6.689375,2.0132813){0.6}{126.869896}{180.0}
% \usefont{T1}{ppl}{m}{n}
% \rput(0.08515625,6.923281){v}
% \usefont{T1}{ppl}{m}{n}
% \rput(3.1215625,6.923281){w}
% \psline[linewidth=0.01cm](0.189375,6.713281)(0.189375,6.5132813)
% \psline[linewidth=0.01cm](3.189375,6.713281)(3.189375,6.5132813)
% \psline[linewidth=0.01cm](0.089375,6.6132812)(0.289375,6.6132812)
% \psline[linewidth=0.01cm](3.289375,6.6132812)(3.089375,6.6132812)
% \psframe[linewidth=0.01,dimen=outer](14.689375,7.0132813)(11.689375,2.0132813)
% \usefont{T1}{ppl}{m}{n}
% \rput(11.5725,7.423281){a}
% \usefont{T1}{ppl}{m}{n}
% \rput(14.577344,7.423281){b}
% \psline[linewidth=0.02cm,linestyle=dashed,dash=0.16cm 0.16cm,arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.4]{->}(14.689375,2.0132813)(13.189375,6.6132812)
% \psline[linewidth=0.02cm,linestyle=dashed,dash=0.16cm 0.16cm,arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.4]{->}(11.689375,2.0132813)(10.189375,6.6132812)
% \psline[linewidth=0.04cm](10.189375,6.6132812)(13.189375,6.6132812)
% \usefont{T1}{ppl}{m}{n}
% \rput(11.277344,1.9232812){d}
% \usefont{T1}{ppl}{m}{n}
% \rput(14.967188,1.9232812){c}
% \psarc[linewidth=0.01](11.689375,2.0132813){0.6}{0.0}{108.43495}
% \psarc[linewidth=0.01](14.689375,2.0132813){0.6}{108.43495}{180.0}
% \usefont{T1}{ppl}{m}{n}
% \rput(10.085156,6.923281){v}
% \usefont{T1}{ppl}{m}{n}
% \rput(13.121563,6.923281){w}
% \psline[linewidth=0.01cm](10.189375,6.713281)(10.189375,6.5132813)
% \psline[linewidth=0.01cm](13.189375,6.713281)(13.189375,6.5132813)
% \psline[linewidth=0.01cm](10.089375,6.6132812)(10.289375,6.6132812)
% \psline[linewidth=0.01cm](13.289375,6.6132812)(13.089375,6.6132812)
% \psframe[linewidth=0.01,dimen=outer](6.689375,-1.9867188)(3.689375,-6.9867187)
% \usefont{T1}{ppl}{m}{n}
% \rput(3.5725,-1.5767188){a}
% \usefont{T1}{ppl}{m}{n}
% \rput(6.577344,-1.5767188){b}
% \psline[linewidth=0.02cm,linestyle=dashed,dash=0.16cm 0.16cm,arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.4]{->}(6.689375,-6.9867187)(5.189375,-2.3867188)
% \psline[linewidth=0.02cm,linestyle=dashed,dash=0.16cm 0.16cm,arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.4]{->}(3.689375,-6.9867187)(4.224311,-2.3916135)
% \psline[linewidth=0.04cm](4.224311,-2.3916135)(5.189375,-2.3916135)
% \usefont{T1}{ppl}{m}{n}
% \rput(3.2773438,-7.076719){d}
% \usefont{T1}{ppl}{m}{n}
% \rput(6.9671874,-7.076719){c}
% \psarc[linewidth=0.01](3.689375,-6.9867187){0.6}{0.0}{80.53768}
% \psarc[linewidth=0.01](6.689375,-6.9867187){0.6}{108.43495}{180.0}
% \usefont{T1}{ppl}{m}{n}
% \rput(3.9851563,-2.1767187){v}
% \usefont{T1}{ppl}{m}{n}
% \rput(5.4215627,-2.1767187){w}
% \psline[linewidth=0.01cm](4.224311,-2.2917197)(4.224311,-2.491507)
% \psline[linewidth=0.01cm](5.189375,-2.2867188)(5.189375,-2.4867187)
% \psframe[linewidth=0.01,dimen=outer](22.689375,-1.9867188)(19.689375,-6.9867187)
% \usefont{T1}{ppl}{m}{n}
% \rput(19.5725,-1.5767188){a}
% \usefont{T1}{ppl}{m}{n}
% \rput(22.577343,-1.5767188){b}
% \psline[linewidth=0.02cm,linestyle=dashed,dash=0.16cm 0.16cm,arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.4]{->}(19.689375,-6.9867187)(23.289375,-2.3867188)
% \psline[linewidth=0.02cm,linestyle=dashed,dash=0.16cm 0.16cm,arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.4]{->}(22.689375,-6.9867187)(19.124311,-2.3916135)
% \psline[linewidth=0.04cm](19.089375,-2.3867188)(23.189375,-2.3867188)
% \usefont{T1}{ppl}{m}{n}
% \rput(19.277344,-7.076719){d}
% \usefont{T1}{ppl}{m}{n}
% \rput(22.967188,-7.076719){c}
% \psarc[linewidth=0.01](19.689375,-6.9867187){0.6}{0.0}{53.130104}
% \psarc[linewidth=0.01](22.689375,-6.9867187){0.6}{126.869896}{180.0}
% \usefont{T1}{ppl}{m}{n}
% \rput(18.885157,-2.1767187){v}
% \usefont{T1}{ppl}{m}{n}
% \rput(23.421562,-2.1767187){w}
% \psline[linewidth=0.01cm](19.124311,-2.2917197)(19.124311,-2.491507)
% \psline[linewidth=0.01cm](23.189375,-2.2867188)(23.189375,-2.4867187)
% \psline[linewidth=0.01cm](18.989374,-2.3867188)(19.156479,-2.3916135)
% \psline[linewidth=0.01cm](23.289375,-2.3867188)(23.089375,-2.3867188)
% \psframe[linewidth=0.01,dimen=outer](14.689375,-1.9867188)(11.689375,-6.9867187)
% \usefont{T1}{ppl}{m}{n}
% \rput(11.5725,-1.5767188){a}
% \usefont{T1}{ppl}{m}{n}
% \rput(14.577344,-1.5767188){b}
% \psline[linewidth=0.02cm,linestyle=dashed,dash=0.16cm 0.16cm,arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.4]{->}(14.689375,-6.9867187)(15.189375,-2.3867188)
% \psline[linewidth=0.02cm,linestyle=dashed,dash=0.16cm 0.16cm,arrowsize=0.05291667cm 2.0,arrowlength=1.4,arrowinset=0.4]{->}(11.689375,-6.8867188)(11.1243105,-2.3916135)
% \psline[linewidth=0.04cm](11.089375,-2.3867188)(15.189375,-2.3867188)
% \usefont{T1}{ppl}{m}{n}
% \rput(11.277344,-7.076719){d}
% \usefont{T1}{ppl}{m}{n}
% \rput(14.967188,-7.076719){c}
% \psarc[linewidth=0.01](11.689375,-6.9867187){0.6}{0.0}{97.125015}
% \psarc[linewidth=0.01](14.689375,-6.9867187){0.6}{82.874985}{180.0}
% \usefont{T1}{ppl}{m}{n}
% \rput(10.885157,-2.1767187){v}
% \usefont{T1}{ppl}{m}{n}
% \rput(15.421562,-2.1767187){w}
% \psline[linewidth=0.01cm](11.1243105,-2.2917197)(11.1243105,-2.491507)
% \psline[linewidth=0.01cm](15.189375,-2.2867188)(15.189375,-2.4867187)
% \psline[linewidth=0.01cm](11.092142,-2.3916135)(11.15648,-2.3916135)
% \psline[linewidth=0.01cm](15.289375,-2.3867188)(15.089375,-2.3867188)
% \end{pspicture} 
% }
% 
...
segment is classified as the most likely wall for that line segment.
	...
	%TODO alpha is used now in another context, use other sign!
	%$\alpha_{l} = \fac{lwo}{|l|}$
